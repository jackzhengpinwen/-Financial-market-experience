...
window.oriProductFee?("CNY"!==o.currencyCode&&E.report110809(40),E.reportOverseaPay(o.currencyCode,100*o.price.toFixed(2),1,i,o.countryCode,0,o.err_msg)):(window.IAPProductInfo=o,
window.IAPProductInfo.invokeTime=i);
}else E.report110809(39),E.reportOverseaPay("",0,1,0,"",1,o.err_msg);
}
});
...
E.reportOverseaPay(o.currencyCode,100*o.price.toFixed(2),2,i,o.countryCode,0,o.err_msg);
}else E.report110809(42),E.reportOverseaPay("",0,2,0,"",1,o.err_msg);
}
});
}();
}else{
...
var q=window.user_uin||0,O=Math.floor(q/100)%1e3,T=0!==q&&1001>O,R=!0,C="",N=5,M=_.isIOS&&_.gtVersion("7.0.10",!0)||_.isAndroid&&_.gtVersion("7.0.11",!0),D=M&&""===window.nickname&&""===window.nickname_new?"未命名公众号":window.title;
